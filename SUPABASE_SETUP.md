# RouteHeat 7.0.0 Supabase setup
...
After publishing 7.0.0, open **Settings → Neighborhood Snapshot**, review the disclosure, and enable **Build after finished routes**. The first build requires:
