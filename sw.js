const CACHE = 'routeheat-v612';
const APP = [
  './',
  './index.html',
  './manifest.webmanifest',
  './assets/styles.css?v=6.1.2',
  './assets/app.js?v=6.1.2',
  './assets/cloud.js?v=6.1.2',
  './assets/supabase-config.js?v=6.1.2',
  './assets/routeheat-storage.js?v=6.1.2',
