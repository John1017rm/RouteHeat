const CACHE = 'routeheat-v820-r1';
const APP = [
  './',
  './index.html',
  './manifest.webmanifest',
  './assets/styles.css?v=8.2.0-r1',
  './assets/routeheat-7.css?v=8.2.0-r1',
  './assets/routeheat-8.css?v=8.2.0-r1',
  './assets/app.js?v=8.2.0-r1',
  './assets/cloud.js?v=8.2.0-r1',
  './assets/supabase-config.js?v=8.2.0-r1',
  './assets/routeheat-storage.js?v=8.2.0-r1',
  './assets/route-atmosphere.js?v=8.2.0-r1',
  './assets/route-intake.js?v=8.2.0-r1',
  './assets/pace-orchestra.js?v=8.2.0-r1',
