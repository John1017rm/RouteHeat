const CACHE = 'routeheat-v622';
const APP = [
  './',
  './index.html',
  './manifest.webmanifest',
  './assets/styles.css?v=6.2.2',
  './assets/app.js?v=6.2.2',
  './assets/cloud.js?v=6.2.2',
  './assets/supabase-config.js?v=6.2.2',
  './assets/routeheat-storage.js?v=6.2.2',
  './assets/vendor/leaflet/leaflet.css?v=1.9.4-rh622',
  './assets/vendor/leaflet/leaflet.js?v=1.9.4-rh622',
  './assets/vendor/leaflet/leaflet-heat.js?v=0.2.0-rh622',
