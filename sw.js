const CACHE = 'routeheat-v710';
const APP = [
  './',
  './index.html',
  './manifest.webmanifest',
  './assets/styles.css?v=7.1.0',
  './assets/routeheat-7.css?v=7.1.0',
  './assets/app.js?v=7.1.0',
  './assets/cloud.js?v=7.1.0',
  './assets/supabase-config.js?v=7.1.0',
  './assets/routeheat-storage.js?v=7.1.0',
  './assets/route-atmosphere.js?v=7.1.0',
  './assets/route-intake.js?v=7.1.0',
  './assets/pace-orchestra.js?v=7.1.0',
  './assets/watercolor-atlas.js?v=7.1.0',
