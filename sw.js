const CACHE = 'routeheat-v800-r3';
const APP = [
  './',
  './index.html',
  './manifest.webmanifest',
  './assets/styles.css?v=8.0.0-r3',
  './assets/routeheat-7.css?v=8.0.0-r3',
  './assets/routeheat-8.css?v=8.0.0-r3',
  './assets/app.js?v=8.0.0-r3',
  './assets/cloud.js?v=8.0.0-r3',
  './assets/supabase-config.js?v=8.0.0-r3',
  './assets/routeheat-storage.js?v=8.0.0-r3',
  './assets/route-atmosphere.js?v=8.0.0-r3',
  './assets/route-intake.js?v=8.0.0-r3',
  './assets/pace-orchestra.js?v=8.0.0-r3',
  './assets/watercolor-atlas.js?v=8.0.0-r3',
