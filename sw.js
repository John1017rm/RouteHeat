...
const APP = [
  ...
  './assets/cloud.js?v=6.5.0',
  './assets/supabase-config.js?v=6.5.0',
  './assets/routeheat-storage.js?v=6.5.0',
  './assets/vendor/leaflet/leaflet.css?v=1.9.4-rh650',
  './assets/vendor/leaflet/leaflet.js?v=1.9.4-rh650',
  './assets/vendor/leaflet/leaflet-heat.js?v=0.2.0-rh650',
