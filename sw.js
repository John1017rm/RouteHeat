const CACHE = 'routeheat-v630';
const APP = [
  './',
  './index.html',
  './manifest.webmanifest',
  './assets/styles.css?v=6.3.0',
  './assets/app.js?v=6.3.0',
  './assets/cloud.js?v=6.3.0',
  './assets/supabase-config.js?v=6.3.0',
  './assets/routeheat-storage.js?v=6.3.0',
  './assets/vendor/leaflet/leaflet.css?v=1.9.4-rh630',
  './assets/vendor/leaflet/leaflet.js?v=1.9.4-rh630',
